...
glmDraw(GLMmodel* model, GLuint mode)
{
  ...
  assert(model->vertices);
    ...
    //ofstream outTexture("longHorns_001_TEX.cpp");
    //ofstream outNormal("longHorns_001_NORM.cpp");
    ofstream outVertices("longHorns_001_VERT.cpp");
...
//outTexture  << "Texture longHorns_001_TEX[]   = \n" << "{\n"    << "     //number of vertices = " << model->numtriangles*3 << "\n\n";
//outNormal   << "Normals longHorns_001_NORM[]     = \n" << "{\n"    << "     //number of vertices = " << model->numtriangles*3 << "\n\n";	
outVertices << "Vertices longHorns_001_VERT[] = \n" << "{\n"    << "     //number of vertices = " << group->numtriangles << "\n\n";  
  ...
  while (group) 
  {
        for (i = 0; i < group->numtriangles; i++) 
        {
            ...
            glVertex3fv(&model->vertices[3 * T(group->triangles[i]).vindices[0]]);
                    ...
                    outVertices << model->vertices[3 * T(group->triangles[i]).vindices[0]] << ",";
            ...
            glVertex3fv(&model->vertices[3 * T(group->triangles[i]).vindices[1]]);
                    ...
                    outVertices << model->vertices[3 * T(group->triangles[i]).vindices[1]] << ",";
            ...
            glVertex3fv(&model->vertices[3 * T(group->triangles[i]).vindices[2]]);
                    ...
                    outVertices << model->vertices[3 * T(group->triangles[i]).vindices[2]] << ",\n";
