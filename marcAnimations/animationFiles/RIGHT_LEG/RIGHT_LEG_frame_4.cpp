...
{
                      rightUpperLeg_ROTATE_FRAMEA[3]   =    rightUpperLeg_SET_04[3]     ;
                      rightUpperLeg_ROTATE_FRAMEA[0]   =    rightUpperLeg_SET_04[0]     ;
                      rightUpperLeg_ROTATE_FRAMEA[1]   =    rightUpperLeg_SET_04[1]     ;
                      rightUpperLeg_ROTATE_FRAMEA[2]   =    rightUpperLeg_SET_04[2]     ;
                 
                      rightLowerLeg_ROTATE_FRAMEA[3]   =    rightLowerLeg_SET_04[3]     ;
                      rightLowerLeg_ROTATE_FRAMEA[0]   =    rightLowerLeg_SET_04[0]     ;
                      rightLowerLeg_ROTATE_FRAMEA[1]   =    rightLowerLeg_SET_04[1]     ;
                      rightLowerLeg_ROTATE_FRAMEA[2]   =    rightLowerLeg_SET_04[2]     ;         
         
                      rightFoot_ROTATE_FRAMEA[3]    =  rightFoot_SET_04[3]     ;
                      rightFoot_ROTATE_FRAMEA[0]   =   rightFoot_SET_04[0]     ;
                      rightFoot_ROTATE_FRAMEA[1]   =   rightFoot_SET_04[1]     ;
                      rightFoot_ROTATE_FRAMEA[2]   =   rightFoot_SET_04[2]     ;           
