if(setSelection_LEFT_LEG == 4)
{
                      ...
                      leftUpperLeg_ROTATE_FRAMEA[3]   =  leftUpperLeg_SET_04[3]     ;
                      leftUpperLeg_ROTATE_FRAMEA[0]   =  leftUpperLeg_SET_04[0]     ;
                      leftUpperLeg_ROTATE_FRAMEA[1]   =  leftUpperLeg_SET_04[1]     ;
                      leftUpperLeg_ROTATE_FRAMEA[2]   =  leftUpperLeg_SET_04[2]     ;
                 
                      leftLowerLeg_ROTATE_FRAMEA[3]   =  leftLowerLeg_SET_04[3]     ;
                      leftLowerLeg_ROTATE_FRAMEA[0]   =  leftLowerLeg_SET_04[0]     ;
                      leftLowerLeg_ROTATE_FRAMEA[1]   =  leftLowerLeg_SET_04[1]     ;
                      leftLowerLeg_ROTATE_FRAMEA[2]   =  leftLowerLeg_SET_04[2]     ;         
         
                      leftFoot_ROTATE_FRAMEA[3]   =   leftFoot_SET_04[3]     ;
                      leftFoot_ROTATE_FRAMEA[0]   =   leftFoot_SET_04[0]     ;
                      leftFoot_ROTATE_FRAMEA[1]   =   leftFoot_SET_04[1]     ;
                      leftFoot_ROTATE_FRAMEA[2]   =   leftFoot_SET_04[2]     ;          
